...
if(isset($_GET['id'])  &&  $_GET['id']>0){
    ...
    if(mysqli_num_rows($res)==0){   //for url error
        redirect('users.php');
        die();
    }
      ...
      $msg= "username already exists";     
            ...
            if($type=="edit")
            {
                ...
                redirect('users.php');
                    ...
                    mysqli_query($con,"insert into users(username,password,role) values ('$username','$password','User')");
                    redirect('users.php');
            }            
    }
}
...
<form method="post" class="form-horizontal">
   ...
   <div class="form-group">												<label class="control-label mb-1">Password</label>
      <input type="text" name="password" required value="<?php echo $password or $new_pass?>" class="form-control" rquired>
   </div>
